...
def custom_command_1():
    ...
    display_output("Button 1 was clicked! Voice input: " + voice_input)
...
button1 = Button(window, text="Button 1", command=custom_command_1)
button2 = Button(window, text="Button 2", command=custom_command_2)
