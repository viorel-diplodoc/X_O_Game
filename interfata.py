...
from tkinter import Text, Label, Button, Tk, StringVar, END
...
def recunoastere_nume(variabila_jucator,eticheta):
    ...
    try:
        ...
        print("Recunoașterea vocii a eșuat. Vă rugăm să încercați din nou.")
...
def afiseaza_tabel():
    ...
    eticheta_titlu = Label(window, text='Joc X și O')
    eticheta_titlu.grid(row=0, column=0, padx=10, pady=10)
    
    
    for i, litera in enumerate(['1', '2', '3']):
